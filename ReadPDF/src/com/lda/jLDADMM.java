...
public class jLDADMM
{
    public static void main(String[] args)
    {
        ...
        try {
            ...
            if (cmdArgs.model.equals("LDA")) {
                GibbsSamplingLDA lda = new GibbsSamplingLDA(cmdArgs.corpus, cmdArgs.ntopics,
                        cmdArgs.alpha, cmdArgs.beta, cmdArgs.niters, cmdArgs.twords,
                        cmdArgs.expModelName, cmdArgs.initTopicAssgns, cmdArgs.savestep);
                lda.inference();
            }
            else if (cmdArgs.model.equals("DMM")) {
                GibbsSamplingDMM dmm = new GibbsSamplingDMM(cmdArgs.corpus, cmdArgs.ntopics,
                        cmdArgs.alpha, cmdArgs.beta, cmdArgs.niters, cmdArgs.twords,
                        cmdArgs.expModelName, cmdArgs.initTopicAssgns, cmdArgs.savestep);
                dmm.inference();
            }
                ...
                System.out.println("\tLDA: Specify the Latent Dirichlet Allocation topic model");
                System.out
    ...
    {
        System.out.println("java -jar jLDADMM.jar [options ...] [arguments...]");
